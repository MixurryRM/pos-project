        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block mt-3">
                <a href="" class="text-decoration-none">
                    <span class="h2 text-uppercase text-white bg-dark px-2">MY</span>
                    <span class="h2 text-uppercase text-dark bg-warning px-2 ml-n1">Shop</span>
                </a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('user#contactPageList') }}" class="nav-item nav-link">Contact</a>
                        </div>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Our
                                Shop</a>
                            <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Shop
                                Detail</a>
                            <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Shopping
                                Cart</a>
