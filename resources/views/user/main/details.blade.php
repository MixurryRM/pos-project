...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <a href="{{ route('user#home') }}" class=" text-dark"><i class="fa-solid fa-arrow-left"></i></a>
            <div class="col-lg-5 mb-30 py-3">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100" style="height: 80%" src="{{ asset('storage/' . $pizza->image) }}"
                                alt="Image">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn  btn-warning px-3" id="addCartBtn"><i class="fa fa-shopping-cart mr-1"></i> Add
                            To
                            Cart</button>
                    </div>
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-warning pr-3">You May
                Also Like</span></h2>
        <div class="row px-xl-5">
            <div class="col">
