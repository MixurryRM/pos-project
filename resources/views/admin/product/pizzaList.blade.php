                ...
                <div class="col-md-12">
                    ...
                    <div class="row mt-2 ">
                        <div class="col-1 offset-10 shadow-sm bg-white p-2 text-center">
                            <i class="fa-solid fa-database mr-2"></i> {{ $pizzas->total() }}
                        </div>
                    </div>
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2 text-center">
                                ...
                                <tbody>
                                    @foreach ($pizzas as $p)
                                        <tr class="tr-shadow">
                                            <td class=" col-2"><img src="{{ asset('storage/' . $p->image) }}" alt=""
                                                    srcset="" class="img-thumbnail shadow-sm">
                                            </td>
                                            <td>{{ $p->name }}</td>
                                            <td> {{ $p->price }} </td>
                                            ...
                                            <td class="">
                                                <div class="table-data-feature">
                                                    <a href="{{ route('product#edit', $p->id) }}" class=" mr-2">
                                                        <button class="item me-1" data-toggle="tooltip" data-placement="top"
                                                            title="View">
                                                            <i class="fa-solid fa-eye"></i>
                                                        </button>
                                                    </a>
                                                    <a href="{{ route('product#updatePage', $p->id) }}" class=" mr-2">
                                                        <button class="item me-1" data-toggle="tooltip" data-placement="top"
                                                            title="Edit">
                    ...
                    @else
                        <h3 class=" text-secondary text-center">There Is No Pizzas Here!</h3>
                    @endif
                    <!-- END DATA TABLE -->
                </div>
            </div>
